...
const FacultyAttendance = () => {
  ...
  const fetchTodaySchedules = async () => {
    ...
    try {
      ...
      // Always select the first schedule for the chosen date to avoid stale selection from previous date
      setSelectedSchedule(schedulesData.length > 0 ? schedulesData[0] : null);
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-white p-4 md:p-6 shadow">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-end sm:space-x-4">
            ...
            <div className="sm:pt-6">
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-md bg-gray-100 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-200 sm:w-auto"
              >
                Refresh
              </button>
            </div>
